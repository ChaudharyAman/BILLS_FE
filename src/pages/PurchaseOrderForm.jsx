      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="px-6 py-4 border-b border-gray-200 dark:border-slate-800 bg-gray-50 dark:bg-slate-900/60 transition-colors">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <label className="text-sm text-gray-600 dark:text-slate-400 w-28 flex-shrink-0">Vendor name</label>
            ...
            <div className="space-y-2">
              {/* Row 1: Doc No + Date */}
              <div className="flex items-center gap-3">
                <label className="text-sm text-gray-600 dark:text-slate-400 w-28 flex-shrink-0">{docNoLabel}</label>
                ...
                <input type="text" placeholder="2" value={formData.docNoSuffix}
                  ...
                  className={`${inp} w-16`} />
                <label className="text-sm text-gray-600 dark:text-slate-400 w-28 flex-shrink-0 text-right">PO date</label>
              ...
              <div className="flex items-center gap-3">
                ...
                <label className="text-sm text-gray-600 dark:text-slate-400 w-24 flex-shrink-0 text-right">Valid until</label>
              ...
              <div className="flex items-center gap-3">
                <label className="text-sm text-gray-600 dark:text-slate-400 w-28 flex-shrink-0">Status</label>
                <select
        ...
        <div className="px-6 py-4 border-t border-gray-200 dark:border-slate-800 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1.5">
              Private notes <span className="text-gray-400 dark:text-slate-500 font-normal">(not shown to vendor)</span>
            </label>

                    ...
                    <tbody className="divide-y divide-gray-100 dark:divide-slate-800/60">
                        {filteredClients.map((client) => (
                            <tr key={client._id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                                ...
                                <td className="px-4 py-4">
                                    <Link to={`/clients/edit/${client._id}`} className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-semibold text-sm">
                                        {client.name}
                                    </Link>
                                </td>
                                ...
                                <td className="px-4 py-4 text-center">
                                    <div className="flex items-center justify-center gap-3">
                                      <Link to={`/clients/edit/${client._id}`} className="text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors" title="Edit">
                                        <FaPencilAlt size={14} />
                                      </Link>
                                      <button 
                                          onClick={() => {
                                          ...
                                          className={`transition-colors ${isPro ? 'text-slate-300 dark:text-slate-500 hover:text-red-500 dark:hover:text-red-400' : 'text-slate-200 dark:text-slate-600 hover:text-slate-400'}`}
